      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-8 transform hover:scale-105 transition-transform duration-300">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Shipping Policy - Doko</h1>
          </div>
        ...
        {/* Contact Information */}
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 mb-8 transform hover:scale-105 transition-transform duration-300">
